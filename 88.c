// CREATE A PROGRAM WHERE YOU NEED TO STORE AND PROCESS DATA FOR A BOOK WITH ATTRIBUTES LIKE TITLE,AUTHOR AND PRICE DEMONSTRATE WHY A STRUCTURE IS MORE SUITABLE THEN SEPARATE VARIABLE//
